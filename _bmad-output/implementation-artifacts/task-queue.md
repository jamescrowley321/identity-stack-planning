...
| ID | Issue | Status | Description | Size |
|----|-------|--------|-------------|------|
| IM.P1 | [638](https://github.com/jamescrowley321/identity-model/issues/638) | in-progress | Diff-scoped mutation gates for Go (go-gremlins) + Rust (cargo-mutants `--in-diff`), mirroring the Python `mutation-security` contract (mutants on changed security-surface lines must be killed or waived-equivalent; mechanical, fail-closed). Implementation PR in flight 2026-09-05 | medium |
| IM.P2 | [639](https://github.com/jamescrowley321/identity-model/issues/639) | audit-done / awaiting decisions | Audit DELIVERED 2026-09-05: [`identity-model-parity-report-2026-09-05.md`](../planning-artifacts/identity-model-parity-report-2026-09-05.md) + feature/CI-gate/test-harness appendices. Headline: Py ≈98% / Go ≈58% / Rust ≈52% row-weighted; 2 of 4 inversions closed by the id-token stack (I-2 nonce, I-4 azp), I-1 client_secret_post + I-3 RFC 8414 issuer match remain — **decision record D-1..D-4 awaits owner sign-off**. New issues [642](https://github.com/jamescrowley321/identity-model/issues/642)–[646](https://github.com/jamescrowley321/identity-model/issues/646); [577](https://github.com/jamescrowley321/identity-model/issues/577) closed as delivered; [574](https://github.com/jamescrowley321/identity-model/issues/574)/[608](https://github.com/jamescrowley321/identity-model/issues/608) rescoped with evidence. Remaining: execute reconciliation per the report's sequencing | large |
